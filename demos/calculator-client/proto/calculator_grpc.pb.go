...
const (
	...
	Calculator_Subtract_FullMethodName = "/calculator.v1.Calculator/Subtract"
	Calculator_Multiply_FullMethodName = "/calculator.v1.Calculator/Multiply"
	Calculator_Divide_FullMethodName   = "/calculator.v1.Calculator/Divide"
	Calculator_Health_FullMethodName   = "/calculator.v1.Calculator/Health"
)
...
func (c *calculatorClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCalculatorServer) Health(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _Calculator_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Health(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
